...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func IDActionsOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ActionsController, id int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func HelloActionsOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ActionsController, name string) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
